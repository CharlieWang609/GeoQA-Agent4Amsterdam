...
variable "google_api_key_secret_id" {
  description = "Versionless or versioned Key Vault secret URI for the Google (Gemini) API key."
  type        = string
  sensitive   = true
}

variable "deepseek_api_key_secret_id" {
  description = "Versionless or versioned Key Vault secret URI for the DeepSeek API key."
  type        = string
  sensitive   = true
}

variable "gee_service_account_key_secret_id" {
  description = "Versionless or versioned Key Vault secret URI holding the Earth Engine service-account key JSON."
  type        = string
  sensitive   = true
}
